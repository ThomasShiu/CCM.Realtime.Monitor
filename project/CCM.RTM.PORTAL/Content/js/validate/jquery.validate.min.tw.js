...
(function (c) {
    ...
    c.extend(c.validator, {
        ...
        messages: {
            ...
            maxlength: c.validator.format("請輸入一個長度最多是 {0} 的字串"),
            minlength: c.validator.format("請輸入一個長度最少是 {0} 的字串"),
            rangelength: c.validator.format("請輸入一個長度介於 {0} 和 {1} 之間的字串"),
            range: c.validator.format("請輸入一個介於 {0} 和 {1} 之間的值"),
            max: c.validator.format("請輸入一個最大為 {0} 的值"),
            min: c.validator.format("請輸入一個最小為 {0} 的值")
        },
...
$(function () {
    ...
    // 匹配密碼，以字母開頭，長度在6-12之間，只能包含字元、數位和底線。      
    jQuery.validator.addMethod("isPwd", function (value, element) {
        return this.optional(element) || /^[a-zA-Z]\\w{6,12}$/.test(value);
    }, "以字母開頭，長度在6-12之間，只能包含字元、數位和底線。");
    // IP地址驗證   
