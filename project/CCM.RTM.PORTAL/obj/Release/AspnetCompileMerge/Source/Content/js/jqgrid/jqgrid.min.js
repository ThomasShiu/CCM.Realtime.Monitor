            ...
            endReq = function () {
                ...
                if (ts.p.unwritten) {
                    ...
                    if ($("#" + ts.p.id).find('tbody tr').length == 1) {
                        $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').append('<div class="unwritten" style="color:red;padding:7px;border-bottom:#ddd 1px solid;">Sorry~目前查不到任何資料!</div>')
                    }
                }
            },
