...
namespace CCM.Data
{
    ...
    /// 倉儲實現
    /// </summary>
    public class HrsRepositoryBase : IHrsRepositoryBase, IDisposable
    {
        private HRSContext hrsdbcontext = new HRSContext();
        private DbTransaction dbTransaction { get; set; }
        public IHrsRepositoryBase BeginTrans()
        {
            DbConnection dbConnection = ((IObjectContextAdapter)hrsdbcontext).ObjectContext.Connection;
        ...
        public int Commit()
        {
            try
            {
                var returnValue = hrsdbcontext.SaveChanges();
