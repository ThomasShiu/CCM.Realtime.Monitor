...
namespace CCM.Application
{
    ...
    public class USRPMSApp
    {
        private IUSRPMSRepository service = new USRPMSRepository();

        public List<USRPMSEntity> GetList(string keyword = "")
        {
            var expression = ExtLinq.True<USRPMSEntity>();
        ...
        public List<USRPMSEntity> GetList(Pagination pagination, string keyword = "")
        {
            var expression = ExtLinq.True<USRPMSEntity>();
            if (!string.IsNullOrEmpty(keyword))
            {
        ...
        public USRPMSEntity GetForm(string keyValue)
        {
        ...
        public void SubmitForm(USRPMSEntity tableEntity, string keyValue)
        {
