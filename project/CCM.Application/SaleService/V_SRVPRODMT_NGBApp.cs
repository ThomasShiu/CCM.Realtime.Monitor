...
namespace CCM.Application
{
    ...
    public class V_SRVPRODMT_NGBApp
    {
        private IV_SRVPRODMT_NGBRepository service = new V_SRVPRODMT_NGBRepository();

        public List<V_SRVPRODMT_NGBEntity> GetList(string keyword = "")
        {
            var expression = ExtLinq.True<V_SRVPRODMT_NGBEntity>();
        ...
        public List<V_SRVPRODMT_NGBEntity> GetList(Pagination pagination, string keyword = "")
        {
            try
            {
                var expression = ExtLinq.True<V_SRVPRODMT_NGBEntity>();
        ...
        public V_SRVPRODMT_NGBEntity GetForm(string keyValue)
        {
